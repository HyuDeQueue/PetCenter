<%-- 
    Document   : updatepet
    Created on : Mar 5, 2024, 2:19:35 AM
    Author     : Windows 10
--%>
        ...
        <div id="website-width">
            ...
            <div class="addpet-form">
                ...
                <form action="updatepet" method="post">
                    <input type="hidden" name="selectedPetId" value="${selectedPetId}">

                    <p>Tên thú cưng: <input type="text" name="petname"></p>
                    <p>Giới tính thú cưng:
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="petSex" id="inlineRadio1" value="Đực">
                        <label class="form-check-label" for="inlineRadio1">Đực</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="petSex" id="inlineRadio2" value="Cái"d>
                        <label class="form-check-label" for="inlineRadio2">Cái</label>
                    </div>
                    </p>
                    Loại thú cưng: <select name="pettype">
                        <option value="Chó" selected>Chó</option>
                        <option value="Mèo">Mèo</option>
                        <option value="Khác">Khác</option>
                    </select> <br>
                    Cân nặng(cm): <input type="number" step="0.01" name="petweight" min="0"> <br>
                    Chiều dài(cm): <input type="number" step="0.01" name="petlength" min="0"> <br>
                    Chiều cao(cm): <input type="number" step="0.01" name="petheight" min="0"> <br>
                    ...
                    <input type="submit" class='btn btn-success' value="Chỉnh sửa thú cưng" />
